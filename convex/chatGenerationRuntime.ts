 ...
 */
export async function persistConversationMemoryRuntime(
    ctx: ActionCtx,
    args: { turnId: Id<'chatTurns'> }
...
export async function processChatGenerationJobRuntime(
    ctx: ActionCtx,
    args: { jobId: Id<'chatGenerationJobs'> }
) {
