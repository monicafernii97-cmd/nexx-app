    ...
    handler: async (ctx, args) => {
        ...
        if (existing) {
            const maybeUpdates = {
                ...
                legalRelation: args.legalRelation,
...
export const update = mutation({
    args: {
        ...
        legalName: v.optional(v.union(v.string(), v.null())),
        legalRelation: v.optional(v.union(v.array(v.string()), v.null())),
        partyRole: v.optional(v.union(v.literal('petitioner'), v.literal('respondent'), v.null())),
        description: v.optional(v.union(v.string(), v.null())),
        communicationStyle: v.optional(v.union(v.array(v.string()), v.string(), v.null())),
