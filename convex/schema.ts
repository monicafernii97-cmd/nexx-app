...
export default defineSchema({
    ...
    documentUnderstandingRuns: defineTable({
        ...
        version: v.string(),
        model: v.string(),
        stableJobId: v.optional(v.string()),
        totalChunks: v.number(),
        nextChunkIndex: v.number(),
        currentLevel: v.number(),
        nextNodeIndex: v.number(),
        mapBatchSize: v.optional(v.number()),
        reduceBatchSize: v.optional(v.number()),
        resumeCount: v.optional(v.number()),
        lastResumedByUserId: v.optional(v.id('users')),
        lastResumedAt: v.optional(v.number()),
        lastVerifiedNodeId: v.optional(v.string()),
        deadLetterNodeId: v.optional(v.string()),
        deadLetterFailureClass: v.optional(v.string()),
        errorCode: v.optional(v.string()),
        errorMessage: v.optional(v.string()),
        createdAt: v.number(),
        updatedAt: v.number(),
    ...
    documentUnderstandingWorkNodes: defineTable({
        nodeId: v.string(),
        runId: v.id('documentUnderstandingRuns'),
        uploadedFileId: v.id('uploadedFiles'),
        dataProvenance: v.optional(dataProvenanceValidator),
        ...
        cycleAttemptCount: v.optional(v.number()),
        maxAttempts: v.number(),
        strictRetry: v.boolean(),
        leaseId: v.optional(v.string()),
        leaseExpiresAt: v.optional(v.number()),
        outputJson: v.optional(v.string()),
        validationState: v.union(v.literal('pending'), v.literal('verified'), v.literal('failed')),
        ...
        .index('by_run_phase_level', ['runId', 'phase', 'level', 'nodeIndex']),

    documentUnderstandingNodeAttempts: defineTable({
        ...
        .index('by_work_node_attempt', ['workNodeId', 'attempt'])
    ...
    documentUnderstandingRecords: defineTable({
        ...
        finalizationHash: v.optional(v.string()),
        totalChunks: v.number(),
