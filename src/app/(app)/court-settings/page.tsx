        ...
        <div className="max-w-3xl mx-auto">
            ...
            >
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        >
                            <Gavel size={18} style={{ color: '#0A1E54' }} />
                        </div>
            ...
            >
                <div className="flex items-center gap-2 mb-5">
                    <MapPin size={16} style={{ color: '#0A1E54' }} />
                    <h2
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="relative">
                        <label htmlFor="court-state-input" className="block text-xs font-medium mb-1.5" style={{ color: '#A0B1DD' }}>
                            State <span style={{ color: '#0A1E54' }}>*</span>
                        </label>
                        <div className="relative">
                            <input
                                ref={stateInputRef}
                                ...
                                >
                                    {filteredStates.map((s) => (
                                        <button
                                            ...
                                            className="w-full text-left px-3 py-2 text-sm transition-colors hover:bg-[rgba(10, 30, 84,0.08)] cursor-pointer"
                                            style={{
                                                color: s === state ? '#0A1E54' : '#A0B1DD',
                    ...
                    {/* County Typeahead */}
                    <div className="relative">
                        <label htmlFor="court-county-input" className="block text-xs font-medium mb-1.5" style={{ color: '#A0B1DD' }}>
                            County <span style={{ color: '#0A1E54' }}>*</span>
                        </label>
                        <div className="relative">
                            <input
                                ref={countyInputRef}
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="court-name-input" className="block text-xs font-medium mb-1.5" style={{ color: '#A0B1DD' }}>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="cause-number-input" className="block text-xs font-medium mb-1.5" style={{ color: '#A0B1DD' }}>
                            Cause Number
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label htmlFor="judge-input" className="block text-xs font-medium mb-1.5" style={{ color: '#A0B1DD' }}>
                            Assigned Judge
                        </label>
                        <div className="relative">
                            <User
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="judicial-district-input" className="block text-xs font-medium mb-1.5" style={{ color: '#A0B1DD' }}>
                            Judicial District
                        </label>
                        <div className="relative">
                            <Building2
            ...
            >
                ...
                <p className="text-xs mb-4" style={{ color: '#B39A84' }}>
                    ...
                    {verifyResult && (
                        ...
                        >
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs font-medium" style={{ color: '#A0B1DD' }}>
