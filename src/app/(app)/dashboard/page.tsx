...
function DashboardContent() {
    ...
    return (
        <PageContainer noHorizontalPadding>
            ...
            <div className="max-w-3xl mx-auto w-full px-4 sm:px-6 space-y-16 pb-16 pt-6">
                
                {/* Asymmetrical Pipeline Launcher */}
                <div id="pipeline-switcher" className="grid grid-cols-2 gap-4 sm:gap-6 items-start">
                        ...
                        {pipelineCards.map((card, i) => {
                            ...
                            return (
                                <Link key={card.label} href={card.href} className="no-underline block">
                                    ...
                                    >
                                      <div className={`floating-element hyper-glass flex flex-col items-center justify-center group relative overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:glow-slate w-full px-6 ${isStandard ? 'h-40 sm:h-44' : 'h-56 sm:h-60'}`}>
                                        ...
                                        <h3 className="text-[16px] sm:text-[18px] font-serif text-white mb-1 tracking-tight drop-shadow-sm text-center leading-tight">
                                            {card.label}
                                        </h3>
                                        <p className="text-[11px] sm:text-[12px] text-white/40 font-medium uppercase tracking-[0.12em] drop-shadow-sm text-center px-2 leading-tight">
                                            {card.subtitle}
                                        </p>
