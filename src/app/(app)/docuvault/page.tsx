                ...
                {showGallery && (
                    <>
                        ...
                        <motion.div
                            ...
                            style={{
                                background: 'linear-gradient(180deg, #D9CBC2 0%, #CFC7C8 100%)',
                                borderRight: '1px solid rgba(10, 30, 84, 0.15)',
                            }}
                        >
                            <div className="p-6">
                                <div className="flex items-center justify-between mb-6">
                                    <h2 className="text-lg font-serif font-semibold" style={{ color: '#0A1E54' }}>
                                        Template Gallery
                                    </h2>
                                    <button
                                        onClick={() => setShowGallery(false)}
                                        className="w-8 h-8 rounded-lg flex items-center justify-center cursor-pointer transition-colors"
                                        style={{ background: 'rgba(10, 30, 84, 0.08)' }}
                                    >
                                        <X size={16} style={{ color: '#0A1E54' }} />
                                    </button>
                                </div>
                                            ...
                                            <div className="space-y-1">
                                                {tabTemplates.map(tmpl => (
                                                    <button
                                                        ...
                                                        style={{
                                                            color: selectedTemplate?.id === tmpl.id ? '#0A1E54' : '#A0B1DD',
                                ...
                                <div className="mt-6 pt-4" style={{ borderTop: '1px solid rgba(10, 30, 84, 0.1)' }}>
                                    <Link href="/docuvault/gallery" className="no-underline">
                                        <div
                                            className="flex items-center gap-3 px-3 py-3 rounded-xl cursor-pointer transition-all"
                                            style={{ background: 'rgba(10, 30, 84, 0.05)' }}
                                        >
                                            <FileText size={16} style={{ color: '#0A1E54' }} />
                                            <div>
                                                <p className="text-sm font-medium" style={{ color: '#0A1E54' }}>
                                                    Saved Documents
                                                </p>
                                            ...
                                            <ArrowRight size={14} className="ml-auto" style={{ color: '#0A1E54' }} />
                                        </div>
                                    </Link>
                                </div>
                            </div>
                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            >
                                <Menu size={18} style={{ color: '#0A1E54' }} />
                            </button>
                            <div>
                                <div className="flex items-center gap-3 mb-1">
                                    <div
                                        ...
                                        style={{
                                            ...
                                            border: '1px solid rgba(10, 30, 84, 0.25)',
                                        }}
                                    >
                                        <Landmark size={20} style={{ color: '#0A1E54' }} />
                                    </div>
                            ...
                            <button
                                ...
                                style={{
                                    background: activeTab === tab.id
                                        ...
                                        : 'rgba(179, 154, 132, 0.4)',
                                    color: activeTab === tab.id ? '#0A1E54' : '#B39A84',
                    ...
                    >
                            ...
                            {templates.length > 3 && (
                                <div className="flex gap-1">
                                    <button
                                        ...
                                        style={{ background: 'rgba(10, 30, 84, 0.06)' }}
                                    >
                                        <ChevronLeft size={14} style={{ color: '#0A1E54' }} />
                                    </button>
                                    <button
                                        ...
                                        style={{ background: 'rgba(10, 30, 84, 0.06)' }}
                                    >
                                        <ChevronRight size={14} style={{ color: '#0A1E54' }} />
                                    </button>
                                </div>
                            )}
                        </div>
                        ...
                        {activeTab === 'create_own' ? (
                            ...
                            <div
                                ...
                                style={{
                                    borderColor: 'rgba(10, 30, 84, 0.25)',
                                }}
                            >
                                <div className="flex items-center gap-4">
                                    <div
                                        ...
                                        style={{
                                            background: 'rgba(10, 30, 84, 0.08)',
                                            border: '1px dashed rgba(10, 30, 84, 0.3)',
                                        }}
                                    >
                                        <Plus size={22} style={{ color: '#0A1E54' }} />
                                    </div>
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                                <FileText
                                                    size={28}
                                                    style={{
                                                        color: isSelected ? '#0A1E54' : '#5A4A30',
                                                    }}
                                                />
                                            </div>
                                            <p
                                                ...
                                                style={{
                                                    color: isSelected ? '#0A1E54' : '#A0B1DD',
                                                }}
                                            >
                                                {tmpl.title}
                                            </p>
                        ...
                        {selectedTemplate && (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background: 'rgba(10, 30, 84, 0.04)',
                                        border: '1px solid rgba(10, 30, 84, 0.12)',
                                    }}
                                >
                                    <p className="text-xs font-semibold mb-1" style={{ color: '#0A1E54' }}>
                        ...
                        <div className="flex items-center justify-between mt-3">
                            <div className="flex gap-3">
                                <button
                                    ...
                                    style={{ color: '#B39A84', opacity: 0.5 }}
                                >
                            ...
                            return (
                                <div key={i} className="flex flex-col items-center gap-2">
                                    <div
                                        ...
                                        style={{
                                            background: 'rgba(10, 30, 84, 0.06)',
                                            border: '1px solid rgba(10, 30, 84, 0.12)',
                                        }}
                                    >
                                        <Icon size={16} style={{ color: '#B39A84' }} />
                                    </div>
                                    <p
            ...
            {view === 'working' && (
                ...
                >
                    ...
                    <div
                        ...
                        style={{ borderColor: 'rgba(10, 30, 84, 0.15)' }}
                    >
                        <p className="text-xs uppercase tracking-[0.15em] mb-2" style={{ color: '#A0B1DD' }}>
                            Document Context
                        </p>
                    ...
                    <div className="text-center mb-8">
                        ...
                        >
                            <div
                                ...
                                style={{
                                    background: 'linear-gradient(135deg, rgba(10, 30, 84, 0.12), rgba(10, 30, 84, 0.04))',
                                    border: '1px solid rgba(10, 30, 84, 0.2)',
                                }}
                            >
                                <Sparkles size={24} style={{ color: '#0A1E54' }} />
                            </div>
                        </motion.div>
                        <p className="text-sm font-medium" style={{ color: '#0A1E54' }}>
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-2">
                            <p className="text-xs font-semibold tracking-[0.1em] uppercase" style={{ color: '#A0B1DD' }}>
                                Synthesis
                            </p>
                            <p className="text-xs font-bold" style={{ color: '#0A1E54' }}>
                                {Math.round(progress)}%
                            </p>
                        </div>
                        <div
                        ...
                        >
                            <motion.div
                                ...
                                style={{ background: 'linear-gradient(90deg, #0A1E54, #14518E)' }}
                                ...
                                <div className="mt-0.5">
                                    {step.status === 'complete' ? (
                                        ...
                                        <motion.div
                                            ...
                                            className="w-5 h-5 rounded-full flex items-center justify-center"
                                            style={{ background: 'rgba(10, 30, 84, 0.15)' }}
                                        >
                                            <div className="w-2 h-2 rounded-full" style={{ background: '#0A1E54' }} />
                                        </motion.div>
                                    ) : (
                                        <div
                                            className="w-5 h-5 rounded-full flex items-center justify-center"
            ...
            {view === 'result' && (
                ...
                >
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        >
                            <ChevronLeft size={16} style={{ color: '#0A1E54' }} />
                        </button>
                        <div>
                            <h1 className="text-headline text-lg" style={{ color: '#0A1E54' }}>
                    ...
                    >
                        ...
                        >
                            <FileText size={36} style={{ color: '#B39A84' }} />
                        </div>
                        <p className="text-sm font-semibold mb-1" style={{ color: '#0A1E54' }}>
                        ...
                        <div className="flex items-center justify-center gap-6 mt-5">
                            ...
                            >
                                <div
                                    className="w-10 h-10 rounded-full flex items-center justify-center"
                                    style={{ background: 'rgba(10, 30, 84, 0.06)', border: '1px solid rgba(10, 30, 84, 0.15)' }}
                                >
                                    <ArrowRight size={16} className="rotate-90" style={{ color: '#0A1E54' }} />
                                </div>
                                <span className="text-xs" style={{ color: '#B39A84' }}>Download</span>
                            </button>
                            {/* Print */}
                            <button
                                onClick={() => {
                            ...
                            >
                                ...
                                <span className="text-xs" style={{ color: '#B39A84' }}>Print</span>
                            </button>
                            ...
                            >
                                <div
                                    ...
                                    style={{ background: 'rgba(10, 30, 84, 0.06)', border: '1px solid rgba(10, 30, 84, 0.15)' }}
                                >
                                    <Landmark size={16} style={{ color: '#0A1E54' }} />
                                </div>
                                <span className="text-xs" style={{ color: '#B39A84' }}>Save</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        style={{
                            background: 'rgba(179, 154, 132, 0.3)',
                            border: '1px solid rgba(138, 122, 96, 0.1)',
                            opacity: 0.5,
                        }}
                    >
                        <Plus size={16} style={{ color: '#B39A84' }} />
                        <input
                            type="text"
