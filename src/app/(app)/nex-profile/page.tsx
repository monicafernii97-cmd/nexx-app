            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                        ...
                        style={{
                            background: saved ? 'rgba(90, 158, 111, 0.2)' : 'linear-gradient(135deg, #2C5AA0, var(--zinc-700))',
                ...
                <div className="space-y-6">
                    ...
                    <Section icon={<Siren size={18} />} title="NEX Overview">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="text-xs font-medium mb-1.5 block" style={{ color: 'var(--zinc-400)' }}>
                                ...
                                />
                                <p className="text-xs mt-1" style={{ color: 'var(--zinc-400)' }}>NEXX will use this term in conversations</p>
                            </div>
                            <div>
                                <label className="text-xs font-medium mb-1.5 block" style={{ color: 'var(--zinc-400)' }}>
                                    Relationship
                    ...
                    <Section icon={<Brain size={18} />} title="Behavioral Patterns">
                        <p className="text-xs mb-3" style={{ color: 'var(--zinc-100)' }}>
                            ...
                            {BEHAVIOR_OPTIONS.map((behavior) => {
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            background: selected ? 'rgba(239, 68, 68, 0.15)' : 'rgba(63, 63, 70, 0.04)',
                                            border: `1px solid ${selected ? 'rgba(239, 68, 68, 0.4)' : 'rgba(63, 63, 70, 0.1)'}`,
                                            color: selected ? 'var(--danger)' : 'var(--zinc-400)',
                                        }}
                                    >
                                        {behavior}
                                    </button>
                    ...
                    {/* ── Communication Style ── */}
                    <Section icon={<ChatCenteredDots size={18} />} title="Communication Style">
                        <p className="text-xs mb-3" style={{ color: 'var(--zinc-100)' }}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {COMMUNICATION_STYLES.map((style) => (
                                <button
                                    ...
                                    style={{
                                        background: form.communicationStyle === style.value ? 'rgba(63, 63, 70, 0.12)' : 'rgba(63, 63, 70, 0.03)',
                                        border: `1px solid ${form.communicationStyle === style.value ? 'rgba(63, 63, 70, 0.4)' : 'rgba(63, 63, 70, 0.08)'}`,
                                    }}
                                >
                                    <p className="text-sm font-medium" style={{ color: 'var(--zinc-100)' }}>
                                        {style.label}
                                    </p>
                                    <p className="text-xs mt-0.5" style={{ color: 'var(--zinc-100)' }}>{style.description}</p>
                                </button>
                            ))}
                        </div>
                    </Section>
                    ...
                    <Section icon={<Warning size={18} />} title="Known Manipulation Tactics">
                        <p className="text-xs mb-3" style={{ color: 'var(--zinc-100)' }}>
                            ...
                            {MANIPULATION_OPTIONS.map((tactic) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="px-3 py-1.5 rounded-lg text-xs font-medium cursor-pointer transition-all duration-200"
                                        style={{
                                            background: selected ? 'rgba(229, 168, 74, 0.15)' : 'rgba(63, 63, 70, 0.04)',
                                            border: `1px solid ${selected ? 'rgba(229, 168, 74, 0.4)' : 'rgba(63, 63, 70, 0.1)'}`,
                                            color: selected ? 'var(--warning)' : 'var(--zinc-400)',
                                        }}
                                    >
                                        {tactic}
                                    </button>
                    ...
                    {/* ── Trigger Patterns ── */}
                    <Section icon={<Lightning size={18} />} title="Trigger Patterns">
                        <p className="text-xs mb-3" style={{ color: 'var(--zinc-100)' }}>
                        ...
                        <div className="flex gap-2 mb-3">
                            ...
                            <button
                                ...
                                className="px-3 py-2 rounded-lg cursor-pointer transition-colors hover:bg-[rgba(63,63,70,0.15)]"
                                style={{
                        ...
                        {form.triggerPatterns.length > 0 && (
                            <div className="space-y-2">
                                {form.triggerPatterns.map((trigger) => (
                                    ...
                                    >
                                        <span className="text-sm" style={{ color: 'var(--zinc-400)' }}>{trigger}</span>
                                        <button
                    ...
                    {nexProfile?.aiInsights && (
                        <Section icon={<Sparkle size={18} />} title="AI Behavioral Analysis">
                            <div
                            ...
                            >
                                <p className="text-sm leading-relaxed whitespace-pre-wrap" style={{ color: 'var(--zinc-400)' }}>
                                    {nexProfile.aiInsights}
                                </p>
                                {nexProfile.dangerLevel !== undefined && (
                                    <div className="mt-4 flex items-center gap-2">
                                        <span className="text-xs font-medium" style={{ color: 'var(--zinc-100)' }}>Danger Assessment:</span>
                                                ...
                                                <div
                                                    ...
                                                    style={{
                                                        background: level <= (nexProfile.dangerLevel ?? 0)
                                                            ? level >= 4 ? 'var(--danger)' : level >= 3 ? 'var(--warning)' : 'var(--success)'
                                                            : 'rgba(63, 63, 70, 0.08)',
                                                    }}
                                                />
                                            ))}
                                        </div>
                                        <span className="text-xs" style={{ color: 'var(--zinc-100)' }}>
                                ...
                                {nexProfile.detectedPatterns && nexProfile.detectedPatterns.length > 0 && (
                                    <div className="mt-3">
                                        <span className="text-xs font-medium block mb-1.5" style={{ color: 'var(--zinc-100)' }}>AI-Detected Patterns:</span>
