    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <motion.div 
                ...
                className="overflow-hidden rounded-[2rem] border border-white/20 bg-[linear-gradient(135deg,#1E3A8A_0%,rgba(255,255,255,0.15)_100%)] backdrop-blur-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_24px_64px_rgba(0,0,0,0.6)]"
            >
                <UserProfile
                    appearance={{
                        ...nexxClerkAppearance,
