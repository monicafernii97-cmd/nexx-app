    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <motion.div 
                ...
                className="overflow-hidden rounded-xl border border-white/20 bg-[linear-gradient(135deg,#1E3A8A_0%,rgba(255,255,255,0.15)_100%)] backdrop-blur-3xl motion-reduce:backdrop-blur-none shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_24px_64px_rgba(0,0,0,0.6)]"
            >
