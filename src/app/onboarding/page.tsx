                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
                    <div
                        ...
                        style={{
                            ...
                            boxShadow: '0 8px 32px rgba(10, 30, 84, 0.3)',
                        }}
                    >
                        <span className="text-lg font-black" style={{ color: '#0A1E54' }}>N</span>
                    </div>
                    <p className="text-sm" style={{ color: '#B39A84' }}>Loading...</p>
                </motion.div>
            </div>
        );
    }
        ...
        return (
            <div className="silk-bg min-h-screen flex items-center justify-center">
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center max-w-sm px-6">
                    ...
                    <p className="text-sm font-semibold mb-2" style={{ color: '#0A1E54' }}>Connection issue</p>
                        ...
                        <div
                            ...
                            style={{
                                background: i <= currentStep
                                    ? 'linear-gradient(90deg, #0A1E54, #14518E)'
                    ...
                    >
                        ...
                        {currentStep === 0 && (
                            <div className="text-center py-8">
                                ...
                                >
                                    <Sparkles size={28} style={{ color: '#0A1E54' }} />
                                </motion.div>
                                <h1 className="font-serif text-3xl font-bold mb-4" style={{ color: '#0A1E54' }}>
                                    Welcome to <span className="shimmer">NEXX</span>
                                </h1>
                                <p className="text-sm leading-relaxed mb-2" style={{ color: '#A0B1DD' }}>
                                    If you&apos;re here, you already know something isn&apos;t right.
                                </p>
                                <p className="text-sm leading-relaxed" style={{ color: '#B39A84' }}>
                        ...
                        {currentStep === 1 && (
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 mb-2">
                                    <Users size={20} style={{ color: '#0A1E54' }} />
                                    <h2 className="font-serif text-xl font-semibold" style={{ color: '#0A1E54' }}>About You</h2>
                                </div>
                                <div>
                                    <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-2 block" style={{ color: '#A0B1DD' }}>Your Name</label>
                                    <input value={formData.name} onChange={(e) => update('name', e.target.value)} placeholder="First name" className="input-premium" />
                                </div>
                                <div>
                                    <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-2 block" style={{ color: '#A0B1DD' }}>State</label>
                                ...
                                <div>
                                    <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-2 block" style={{ color: '#A0B1DD' }}>County</label>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-2 block" style={{ color: '#A0B1DD' }}>Children</label>
                                    ...
                                    <div>
                                        <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-2 block" style={{ color: '#A0B1DD' }}>Ages</label>
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 mb-2">
                                    <MapPin size={20} style={{ color: '#0A1E54' }} />
                                    <h2 className="font-serif text-xl font-semibold" style={{ color: '#0A1E54' }}>Your Situation</h2>
                                </div>
                                <div>
                                    <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-3 block" style={{ color: '#A0B1DD' }}>Custody Arrangement</label>
                                    {['Joint / Shared Custody', 'Sole Custody', 'Visitation Only', 'No Order Yet', 'Other'].map((opt) => (
                                        <button
                                            ...
                                            style={{
                                                background: formData.custodyType === opt ? 'rgba(10, 30, 84, 0.12)' : 'rgba(179, 154, 132, 0.4)',
                                                border: `1px solid ${formData.custodyType === opt ? 'rgba(10, 30, 84, 0.3)' : 'rgba(10, 30, 84, 0.08)'}`,
                                                color: formData.custodyType === opt ? '#0A1E54' : '#A0B1DD',
                                            }}
                                        >
                                            {opt}
                                        </button>
                                ...
                                <div>
                                    <label className="text-xs font-semibold tracking-[0.1em] uppercase mb-3 block" style={{ color: '#A0B1DD' }}>Do you have an attorney?</label>
                                    <div className="flex gap-3">
                                        {['Yes', 'No', 'Looking'].map((opt) => (
                                            <button
                                                ...
                                                style={{
                                                    background: formData.hasAttorney === opt ? 'rgba(10, 30, 84, 0.12)' : 'rgba(179, 154, 132, 0.4)',
                                                    border: `1px solid ${formData.hasAttorney === opt ? 'rgba(10, 30, 84, 0.3)' : 'rgba(10, 30, 84, 0.08)'}`,
                                                    color: formData.hasAttorney === opt ? '#0A1E54' : '#B39A84',
                                                }}
                                            >
                                                {opt}
                                            </button>
                        ...
                        {currentStep === 3 && (
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 mb-2">
                                    <Heart size={20} style={{ color: '#0A1E54' }} />
                                    <h2 className="font-serif text-xl font-semibold" style={{ color: '#0A1E54' }}>Your NEX</h2>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                    {nexBehaviorOptions.map((opt) => (
                                        <button
                                            ...
                                            style={{
                                                background: formData.nexBehaviors.includes(opt) ? 'rgba(10, 30, 84, 0.1)' : 'rgba(179, 154, 132, 0.4)',
                                                border: `1px solid ${formData.nexBehaviors.includes(opt) ? 'rgba(10, 30, 84, 0.25)' : 'rgba(10, 30, 84, 0.06)'}`,
                                                color: formData.nexBehaviors.includes(opt) ? '#0A1E54' : '#A0B1DD',
                                            }}
                                        >
                                            <div
                                                className="w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0"
                                                style={{
                                                    background: formData.nexBehaviors.includes(opt) ? '#0A1E54' : 'transparent',
                                                    border: `1.5px solid ${formData.nexBehaviors.includes(opt) ? '#0A1E54' : '#B39A84'}`,
                                                }}
                                            >
                                                {formData.nexBehaviors.includes(opt) && <Check size={12} style={{ color: '#0A1E54' }} />}
                                            </div>
                                            {opt}
                                        </button>
                                    ))}
                        ...
                        {currentStep === 4 && (
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 mb-2">
                                    <Target size={20} style={{ color: '#0A1E54' }} />
                                    <h2 className="font-serif text-xl font-semibold" style={{ color: '#0A1E54' }}>Your Goals</h2>
                                </div>
                                <p className="text-sm" style={{ color: '#B39A84' }}>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {goalOptions.map((opt) => (
                                        <button
                                            ...
                                            style={{
                                                background: formData.primaryGoals.includes(opt) ? 'rgba(10, 30, 84, 0.15)' : 'rgba(179, 154, 132, 0.5)',
                                                color: formData.primaryGoals.includes(opt) ? '#0A1E54' : '#B39A84',
                                                border: `1px solid ${formData.primaryGoals.includes(opt) ? 'rgba(10, 30, 84, 0.3)' : 'rgba(10, 30, 84, 0.06)'}`,
                                            }}
                                        >
                                            {opt}
                                        </button>
                        ...
                        {currentStep === 5 && (
                            <div className="space-y-6">
                                <div className="flex items-center gap-3 mb-2">
                                    <FileText size={20} style={{ color: '#0A1E54' }} />
                                    <h2 className="font-serif text-xl font-semibold" style={{ color: '#0A1E54' }}>Important Notice</h2>
                                </div>
                                <div className="card-premium p-5 space-y-3">
                                    <p className="text-sm leading-relaxed" style={{ color: '#D4C9B0' }}>
                                        NEXX is an AI-powered tool that provides <strong style={{ color: '#0A1E54' }}>legal information, strategic guidance, and emotional support</strong>. It is <strong style={{ color: '#0A1E54' }}>not</strong> a law firm, does not provide legal advice, and is not a substitute for a licensed attorney or therapist.
                                    </p>
                                    <p className="text-sm leading-relaxed" style={{ color: '#D4C9B0' }}>
                                    ...
                                    <p className="text-sm leading-relaxed" style={{ color: '#D4C9B0' }}>
                                        If you or your children are in immediate danger, please call <strong style={{ color: '#0A1E54' }}>911</strong> or the National Domestic Violence Hotline at <strong style={{ color: '#0A1E54' }}>1-800-799-7233</strong>.
                                    </p>
                                </div>
                                <button
                                    ...
                                    style={{
                                        background: formData.acceptedDisclaimer ? 'rgba(10, 30, 84, 0.1)' : 'rgba(179, 154, 132, 0.4)',
                                        border: `1px solid ${formData.acceptedDisclaimer ? 'rgba(10, 30, 84, 0.25)' : 'rgba(10, 30, 84, 0.06)'}`,
                                        color: formData.acceptedDisclaimer ? '#0A1E54' : '#A0B1DD',
                                    }}
                                >
                                    <div
                                        className="w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0"
                                        style={{
                                            background: formData.acceptedDisclaimer ? '#0A1E54' : 'transparent',
                                            border: `1.5px solid ${formData.acceptedDisclaimer ? '#0A1E54' : '#B39A84'}`,
                                        }}
                                    >
