...
export const ROUTE_MODE_LABELS: Record<string, { label: string; color: string }> = {
    ...
    order_interpretation: { label: 'Order', color: '#5A8EC9' },
    possession_access_schedule: { label: 'Schedule', color: '#5A9E6F' },
    party_message_draft: { label: 'Message', color: '#7096D1' },
    supportive_strategy: { label: 'Strategy', color: '#E5A84A' },
    co_parent_response: { label: 'Response', color: '#7096D1' },
    documentation_strategy: { label: 'Document', color: '#7C6FA0' },
    deescalation_response: { label: 'De-escalate', color: '#5A9E6F' },
    packed_case_intake: { label: 'Intake', color: '#7C6FA0' },
    litigation_navigation: { label: 'Court Plan', color: '#C75A5A' },
    court_response_planning: { label: 'Response Plan', color: '#C75A5A' },
    pro_se_guidance: { label: 'Pro Se', color: '#5A8EC9' },
    attorney_resource_guidance: { label: 'Resources', color: '#5A9E6F' },
    court_narrative_builder: { label: 'Judge Story', color: '#E5A84A' },
    filing_walkthrough: { label: 'Filing', color: '#C75A5A' },
