...
export function evaluateResponse(
  ...
  const modeKeywordMap: Record<string, RegExp> = {
    ...
    order_interpretation: /\b(order|clause|provision|controls?|interpret|means?)\b/i,
    possession_access_schedule: /\b(possession|access|visitation|schedule|holiday|weekend|exchange|father'?s day|mother'?s day)\b/i,
    party_message_draft: /\b(message|reply|respond|appclose|co[-\s]?parent|draft)\b/i,
